BRACMAT_VERSION := $(shell cat BRACMAT_VERSION)
BRACMAT_DEPS := $(wildcard BRACMAT_*)
DOCKER_TAG_PREFIX := rzuckerm/bracmat:$(BRACMAT_VERSION)
...
$(META_BUILD_TARGET): Dockerfile Makefile $(BRACMAT_DEPS)
